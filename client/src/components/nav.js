...
export const Nav = () => {
  ...
  return (
    <div class="px-4 py-5 mx-auto  bg-green-800 sm:max-w-xl  md:max-w-full md:px-24 lg:px-8">
      ...
      <Link
        ...
        <ul class="flex items-center hidden space-x-8 lg:flex">
          <li>
            <Link
                to="/signup"
                class="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide transition duration-200 rounded shadow-md bg-yellow-300 hover:bg-yellow-400 text-green-800 focus:shadow-outline focus:outline-none"
                aria-label="Sign up"
                title="Sign up"
                disabled
              >
